import { getBpmnFactory, createElement, getBusinessObject } from '../PropertyHelper'
 ...
 */
export function setDocumentation (text, element, modeler, updateProperties) {
  ...
  if (isEmpty(text)) {
    ...
    if (documentations && documentations.length > 0) {
      ...
      documentations = []
      documentations.push(createElement('bpmn:Documentation', { text: text }, element, getBpmnFactory(modeler)))
    }
