  ...
  >
    <a-form :form="form">
      ...
      <a-row :gutter="16" v-if="activeObject">
        <a-col :lg="12" :md="24">
          <span class="detail-label">模型名称</span><span class="detail-content">{{ activeObject.name }}</span>
        </a-col>
        <a-col :lg="12" :md="24">
    ...
    >
      ...
      <a-button v-authorize:PROCESS_MODEL_HISTORIES v-if="activeObject" @click="handleSubmit" type="primary" :loading="formLoading">设为新版本</a-button>
    </div>
